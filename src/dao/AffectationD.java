...
public class AffectationD implements iAffictation {
    Connection conn = ConnectionDB.getInstance().getConnection();
    @Override
    public Optional<Affectation> AddAffictation(Affectation affictation) {
      try {
    ...
    @Override
    public Optional<Affectation> FindOne(String code) {
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery();
            if (resultSet.next()){
                Affectation affectationFind = new Affectation();
