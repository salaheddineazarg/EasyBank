...
public  class  Employe extends Person {
    ...
    private  String email;
     ...
     public Employe(String firstName, String lastName, LocalDate dateBirth, String nbPhone ,String matricule,LocalDate dateRecrutement,String email,List<Affectation> affictations,List<Account> accounts,List<Operation> operations){
